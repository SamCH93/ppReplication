...
regardless whether power prior or hierarchical modeling frameworks are used,
highly precise effect estimates are required. Obtaining high enough estimation
